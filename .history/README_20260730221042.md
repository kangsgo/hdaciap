...
The code is still being organized, and there are currently some slight discrepancies between the code and the model described in the paper.
...
### Place molecules.csv in data_clean/ and run the pipeline
```bash
cd data_clean
